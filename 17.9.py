error = 'перезапусить программу'
sequence_numbers = input('Введите без пробела целые числа: ')
...
if not is_int(sequence_numbers):
    print('\nВ вводе содержатся не цифры не любые числа (введите числа, согласно условиям ввода.)\n')
    print(error)
else:
